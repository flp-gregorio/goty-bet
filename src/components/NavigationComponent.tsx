...
const NavigationComponent = (props: NavHeaderProps) => {
  return (
    <div className="flex-row antialiased text-center text-white font-montserrat uppercase font-bold text-xl h-full w-full py-2 flex items-center justify-center bg-neutral-950">
